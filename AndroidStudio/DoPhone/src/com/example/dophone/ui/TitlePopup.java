...
import com.example.dophone.util.PopupWindowUtil;
...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context, int width, int height) {
		...
		// 获得屏幕的宽度和高度
		mScreenWidth = PopupWindowUtil.getScreenWidth(mContext);
		mScreenHeight = PopupWindowUtil.getScreenHeight(mContext);
	...
	private void populateActions() {
		...
		mListView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					convertView = LayoutInflater.from(mContext).inflate(R.layout.item_popup_listview, null);
				}
				tv_itpop = (TextView) convertView.findViewById(R.id.tv_itpop);
				iv_itpop = (ImageView) convertView.findViewById(R.id.iv_itpop);
				tv_itpop.setTextColor(mContext.getResources().getColor(
				...
				iv_itpop.setImageDrawable(item.mDrawable);
				// 设置文本文字
